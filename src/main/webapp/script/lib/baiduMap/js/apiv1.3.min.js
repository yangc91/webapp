...
(function() {
	...
	var cd = {
//		imgPath: "images/",
		imgPath: "../script/lib/baiduMap/" + "images/",
		cityNames: {
			"\u5317\u4eac": "bj",
			"\u4e0a\u6d77": "sh",
			"\u6df1\u5733": "sz",
...
//							var cP = cN.Config._baseUrl + "getmodules.js";
							var cP = "../script/lib/baiduMap/js/getmodules.js";
							cy.request(cP);
...
//		var cM = "tiles/" + cQ + "/" + cR + "/" + cO + ".png";
//		var cM = "http://127.0.0.1:8080/baiduMapProject/" + "tiles/" + cQ + "/" + cR + "/" + cO + ".png";
//		var cM = "http://11.12.109.125:8220/" + "tiles/" + cQ + "/" + cR + "/" + cO + ".png";
		var cM = _baidumapTileAddress + "/" + "tiles/" + cQ + "/" + cR + "/" + cO + ".png";
	...
	bt.getTilesUrl = function(T, cN) {
		...
		url = this.tileUrls[Math.abs(cP + cM) % this.tileUrls.length] + this.map.currentCity + "/" + this.map.cityCode + "/3/lv" + (21 - cN) + "/" + cP + "," + cM + ".png";
		return url
	};
