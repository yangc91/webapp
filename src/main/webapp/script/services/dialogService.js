...
angular.module('uidialog', [])
    .factory('dialog', ['$modal', '$http', function ($modal, $http) {
        ...
        var template = '<div class="modal-header">\
                ...
                <button ng-show="isShow(mdcOpt.close.show)" ng-disabled="getDisabled(mdcOpt.close)" class="close" ng-class="mdcOpt.close.className" type="button" ng-click="btnClick(-1, mdcOpt.close)" >\
                </button>\
            </div>\
